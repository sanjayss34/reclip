...
def create_dataloader(img_path, txt_path, batch_size, is_train,
    ...
    if opts.simple_format:
        txt_db = ReTxtTokJson(txt_path, -1)
...
def main(opts):
    ...
    if opts.simple_format:
        train_dataloader = create_dataloader(opts.train_img_db, opts.train_txt_db,
                                             ...
                                             ReTrainJsonDataset, re_collate, opts)
...
if __name__ == '__main__':
    ...
    # Use JSON/pt formats for data loading
    parser.add_argument('--simple_format', action="store_true", help="Use JSON/pt format for data")
